...
Both effects lead to the rotation of E-modes into B-modes \textcolor{red}{which leads to an increase in power in the BB spectrum.}
...
\textcolor{red}{The improvement comes from our choice of value for the PMF generation time versus the decision in} \citet{planck15-19} \textcolor{red}{to marginalise over PMF generation time altogether.}
\st{Using the CMBACT-derived code that} \citet{planck15-19} \st{used, we find a consistent upper limit of $\bpmf < 1.9$\,nG.
Returning to} \textcolor{red}{Using} the  \citet{zucca16} code and adding the ground-based polarization measurements, we find the upper limit is  reduced only slightly to $\bpmf < \upperBall$\,nG. 

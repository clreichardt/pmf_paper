...
\newcommand{\mnu}{\ensuremath{\sum m|\nu}}
...
The sensitivity of CMB experiments is increasing rapidly due to exponentially growing detector counts
...
Finally, CMB stage IV is a planned experiment  with another order of magnitude expansion in detector counts that would (ideally) begin taking data in the early 2020s.
We examine the likely PMF constraints from such an experiment, and consider which aspects of experimental or survey design are important to realizing these constraints. 
...
According to the Cramer-Rao bound, the Fisher information is the lower bound on the uncertainty

We include two external datasets in all forecasts. 
The first are the expected measurements of the  TT, TE and EE spectra from the \planck{} satellite. 
...
We do not expect the future experiments to substantially improve upon \planck{} in these spectra. 
We throw away \planck{} EE data in the overlap region by appropriately increasing the forecast \planck{} EE uncertainties. 
...
We ignore overlaps between the stage III or IV experiments, with the note that the overlap between a Chilean experiment like the Simons Array and South Pole experiment like SPT-3G should be small.
...
However, adding more detectors does 
Of course, 

If you don't require cost-

We assume the beam i

 the beam FWHM (i.e. telescope diameter), 

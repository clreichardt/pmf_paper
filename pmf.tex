...
Quantum mechanical zero-point fluctuations during inflation can generate an approximately scale-invariant PMF with a spectral index close to $n_B = -3$ \citep{Mack:2001gc}. 
In contrast, \tbd{casual} PMFs with bluer spectra are generated by new physics after inflation \citep[Vachaspati][]{YYY}. 

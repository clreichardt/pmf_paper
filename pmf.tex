...
Quantum mechanical zero-point fluctuations during inflation can generate an approximately scale-invariant PMF with a spectral index close to $n_B = -3$ \citep[e.g.,][]{turner88, mack01, }. 
In contrast, causal PMFs with bluer spectra require phase transitions or other new physics after inflation \citep[e.g.,][]{durrer03, subramanian16}. 

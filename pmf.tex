...
\includegraphics[width=0.9\textwidth,clip,trim={1.5cm 12.5cm 5cm 3.8cm}]{pmf_experiments.pdf}
  ...
  Current measurements of CMB B-modes. 
    ...
    The data sets are from POLARBEAR (black; \citet{polarbear}); ACTpol (dark green; \citet{actpol});  BICEP2/Keck Array (red; \citet{bicepkeck}); and SPTpol (purple; \citet{sptpol}). 

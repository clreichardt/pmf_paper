...
\changed{Adding the ground-based polarization measurements reduces the 95\% CL upper limit significantly to $\bpmf < \upperBall$\,nG. }
...
\changed{These results are slightly lower than the \planck{} + \sptpol{} upper limit of $<1.2\,$nG quoted by \citet{zucca16}.}

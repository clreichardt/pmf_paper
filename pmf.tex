...
\author{Dylan Sutton\altaffilmark{\Melbourne}, Chang Feng\altaffilmark{\uci}, and Christian Reichardt\altaffilmark{\Melbourne}}
...
Model   & \apmf &\alens&$r$\\
\hline
\lcdm{} + \apmf{} &  $< \upperAall$ & \mbox{--} & \mbox{--} \\
\lcdm{} + \alens{} & $< \upperAallalens$ &$ \medAlensall \pm  \sigmaAlensall$ &  \mbox{--}\\
\lcdm{} + \alens{} + $r$&  $< \upperAallalensr$&$ \medAlensRall \pm  \sigmaAlensRall$ & $<\upperRall$\\ 
\end{tabular}
\tablecomments{ 
...
\tbd{Add other nb cases???}  \textbf{\textcolor{magenta}{CF: It is not necessary since the scale-invariant case is the most motivated one. Adding more would just be confusing.}}
...
There is also a proposal to build a stage IV experiment, CMB-S4, that would increase the detector counts by another order of magnitude and hopefully begin taking data in the early 2020s. \textbf{A pathfinder to CMB-S4, the Simons Observatory, was funded in 2016.} \textbf{\textcolor{magenta}{CF: either delete it or add something}} 

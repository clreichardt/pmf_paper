...
Quantum mechanical zero-point fluctuations during inflation can generate an approximately scale-invariant PMF with a spectral index close to $n_B = -3$ \citep[e.g.,][]{turner88, mack01}.%\footnote{We select $n_B = -2.9$ as opposed to another number near -3 to facilitate comparison to other PMF papers.} 

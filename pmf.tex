...
\tbd{somewhere around here add arguments for $nb=-2.9$beinbg preferred} 
...
The 95\% CL upper limit on \apmf{} also drops when tensor modes are introduced, as parameterized by the tensor-to-scalar ratio r. 

...
Here \bpmf{} is the rms field strength on a length scale of 1\,Mpc. 
...
We thereforee importance sample the chains to generate a flat prior on \bpmf. 
...
Although outside the scope of this work, it would be interesting to extend this analysis to 4-point estimators for two reasons. 
First, the 4-point limits should improve faster as the noise level falls, and second, in the case of a detection, the 4-point estimators might discriminate between inflationary gravitational waves and tensor PMFs. 

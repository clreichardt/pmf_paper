...
High energy $\gamma$-rays can interact with IR-optical photons and produce electron-positron pairs. 
These pairs should later annihilate in at GeV energies, but the expected GeV flux is missing in the \fermilat{} observations. 
Intergalactic magnetic fields could explain this by deflecting the particles. 

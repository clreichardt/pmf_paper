...
With the minimal cosmological model, the 1-sigma forecasts for \planck{}+\ho{} is $\sigma(\apmf)=0.15$ for a nearly-scale invariant PMF spectrum (i.e.~$n_b=-2.9). (\tbd{need to check how this compares}This is consistent with, although slightly worse than, the upper limits from the real data).  
